...
void GameScene::onTouchesBegan(CCSet* touches, CCEvent* event)
{
...
void GameScene::onTouchesCancelled(CCSet* touches, CCEvent* event)
{
    
}


void GameScene::onTouchesEnded(CCSet* touches, CCEvent* event)
{
...
void GameScene::onTouchesMoved(CCSet* touches, CCEvent* event)
{
